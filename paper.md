...
- [Interactive training-curve generator](https://edgarmanacorda.github.io/eprop_wired_paper/downloads/make_interactive_training_figures.py)
- [3D network-browser generator](https://edgarmanacorda.github.io/eprop_wired_paper/downloads/make_3d_unified_network_browser_per_family.py)
...
A standalone HTML version is also available: [DVS Gesture interactive training curves](https://edgarmanacorda.github.io/eprop_wired_paper/downloads/dvs_gesture_interactive_training_curves.html).
...
A standalone HTML version is also available: [MC_Maze interactive training curves](https://edgarmanacorda.github.io/eprop_wired_paper/downloads/mc_maze_interactive_training_curves.html).
...
- [DVS Gesture 3D network browser](https://edgarmanacorda.github.io/eprop_wired_paper/downloads/dvs_gesture_3d_network.html)
- [MC_Maze 3D network browser](https://edgarmanacorda.github.io/eprop_wired_paper/downloads/mc_maze_3d_network.html)
